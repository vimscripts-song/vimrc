...
winpos 100 50		"设置gvim启动窗口的位置，以及大小   
...
"nmap <C-l> :ConqueTermVSplit bash<CR>
"plugin
...
nmap make<CR> :call ExeMakefile()<CR>
...
"set tags+=/home/song/.vim/sourceCode/opencv-2.4.5/tags
...
nmap <silent><F3> <ESC>:call QFixToggle(0)<CR>
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
